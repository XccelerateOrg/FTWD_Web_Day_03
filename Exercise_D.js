 ...
 * 
 * If the number that is entered is greater than or equal to 1,000,000 it should simply return the number. 
 * 
 * Otherwise it should multiply the number by 10 however many times it takes 
 * to get a number that is greater than or equal to 1,000,000 and return that number. 
 * 
...
console.log(multiplyNumber("100000"));
